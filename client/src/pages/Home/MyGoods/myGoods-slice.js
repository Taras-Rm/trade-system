...
export const getBuyedGoodsSuccess = (goods) => ({
  type: GET_BUYED_GOODS_SUCCESS,
  payload: goods,
});

export const getBuyedGoodsError = (err) => ({
  type: GET_BUYED_GOODS_ERROR,
  payload: err,
});

export const getGoodsForSellStart = () => ({ type: GET_GOODS_FOR_SELL_START });

export const getGoodsForSellSuccess = (goods) => ({
  type: GET_GOODS_FOR_SELL_SUCCESS,
  payload: goods,
});

export const getGoodsForSellError = (err) => ({
  type: GET_GOODS_FOR_SELL_ERROR,
  payload: err,
});

export const deleteGoodsForSellStart = (goodId) => ({
  type: DELETE_GOODS_FOR_SELL_START,
  payload: goodId,
});

export const deleteGoodsForSellSuccess = () => ({
  type: DELETE_GOODS_FOR_SELL_SUCCESS,
});

export const deleteGoodsForSellError = (err) => ({
  type: DELETE_GOODS_FOR_SELL_ERROR,
  payload: err,
});

export const updateGoodsForSellStart = (good) => ({
  type: UPDATE_GOODS_FOR_SELL_START,
  payload: good,
});

export const updateGoodsForSellSuccess = () => ({
  type: UPDATE_GOODS_FOR_SELL_SUCCESS,
});

export const stopUpdateGoodsForSell = () => ({
  type: STOP_UPDATE_GOODS_FOR_SELL,
});

export const updateGoodsForSellError = (err) => ({
  type: UPDATE_GOODS_FOR_SELL_ERROR,
  payload: err,
});
